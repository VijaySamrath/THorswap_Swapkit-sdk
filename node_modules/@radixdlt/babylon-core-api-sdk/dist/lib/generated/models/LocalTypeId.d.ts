 ...
 * @export
 */
export declare const LocalTypeIdKindEnum: {
    readonly WellKnown: "WellKnown";
    readonly SchemaLocal: "SchemaLocal";
};
 ...
 */
export declare function instanceOfLocalTypeId(value: object): boolean;
export declare function LocalTypeIdFromJSON(json: any): LocalTypeId;
export declare function LocalTypeIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocalTypeId;
export declare function LocalTypeIdToJSON(value?: LocalTypeId | null): any;
