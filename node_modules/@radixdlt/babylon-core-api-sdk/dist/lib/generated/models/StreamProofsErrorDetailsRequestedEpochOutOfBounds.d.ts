 ...
 * @export
 */
export declare const StreamProofsErrorDetailsRequestedEpochOutOfBoundsTypeEnum: {
 ...
 */
export declare function instanceOfStreamProofsErrorDetailsRequestedEpochOutOfBounds(value: object): boolean;
export declare function StreamProofsErrorDetailsRequestedEpochOutOfBoundsFromJSON(json: any): StreamProofsErrorDetailsRequestedEpochOutOfBounds;
export declare function StreamProofsErrorDetailsRequestedEpochOutOfBoundsFromJSONTyped(json: any, ignoreDiscriminator: boolean): StreamProofsErrorDetailsRequestedEpochOutOfBounds;
export declare function StreamProofsErrorDetailsRequestedEpochOutOfBoundsToJSON(value?: StreamProofsErrorDetailsRequestedEpochOutOfBounds | null): any;
