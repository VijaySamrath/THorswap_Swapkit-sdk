 ...
 * @export
 */
export declare const EcdsaSecp256k1SignatureWithPublicKeyAllOfKeyTypeEnum: {
 ...
 */
export declare function instanceOfEcdsaSecp256k1SignatureWithPublicKeyAllOf(value: object): boolean;
export declare function EcdsaSecp256k1SignatureWithPublicKeyAllOfFromJSON(json: any): EcdsaSecp256k1SignatureWithPublicKeyAllOf;
export declare function EcdsaSecp256k1SignatureWithPublicKeyAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): EcdsaSecp256k1SignatureWithPublicKeyAllOf;
export declare function EcdsaSecp256k1SignatureWithPublicKeyAllOfToJSON(value?: EcdsaSecp256k1SignatureWithPublicKeyAllOf | null): any;
