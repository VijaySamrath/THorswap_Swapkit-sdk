 ...
 * @export
 */
export declare const ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate(value: object): boolean;
export declare function ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstateFromJSON(json: any): ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate;
export declare function ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate;
export declare function ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstateToJSON(value?: ConsensusManagerRegisteredValidatorsByStakeIndexEntrySubstate | null): any;
