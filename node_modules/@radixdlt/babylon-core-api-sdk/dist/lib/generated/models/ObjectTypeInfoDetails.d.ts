 ...
 * @export
 */
export declare const ObjectTypeInfoDetailsTypeEnum: {
 ...
 */
export declare function instanceOfObjectTypeInfoDetails(value: object): boolean;
export declare function ObjectTypeInfoDetailsFromJSON(json: any): ObjectTypeInfoDetails;
export declare function ObjectTypeInfoDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ObjectTypeInfoDetails;
export declare function ObjectTypeInfoDetailsToJSON(value?: ObjectTypeInfoDetails | null): any;
