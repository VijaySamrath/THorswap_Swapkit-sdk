 ...
 * @export
 */
export declare const TransactionTrackerFieldStateSubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfTransactionTrackerFieldStateSubstate(value: object): boolean;
export declare function TransactionTrackerFieldStateSubstateFromJSON(json: any): TransactionTrackerFieldStateSubstate;
export declare function TransactionTrackerFieldStateSubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionTrackerFieldStateSubstate;
export declare function TransactionTrackerFieldStateSubstateToJSON(value?: TransactionTrackerFieldStateSubstate | null): any;
