 ...
 * @export
 */
export declare const ConsensusManagerFieldCurrentTimeSubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfConsensusManagerFieldCurrentTimeSubstate(value: object): boolean;
export declare function ConsensusManagerFieldCurrentTimeSubstateFromJSON(json: any): ConsensusManagerFieldCurrentTimeSubstate;
export declare function ConsensusManagerFieldCurrentTimeSubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsensusManagerFieldCurrentTimeSubstate;
export declare function ConsensusManagerFieldCurrentTimeSubstateToJSON(value?: ConsensusManagerFieldCurrentTimeSubstate | null): any;
