 ...
 * @export
 */
export declare const StateNonFungibleResourceManagerAllOfResourceTypeEnum: {
 ...
 */
export declare function instanceOfStateNonFungibleResourceManagerAllOf(value: object): boolean;
export declare function StateNonFungibleResourceManagerAllOfFromJSON(json: any): StateNonFungibleResourceManagerAllOf;
export declare function StateNonFungibleResourceManagerAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): StateNonFungibleResourceManagerAllOf;
export declare function StateNonFungibleResourceManagerAllOfToJSON(value?: StateNonFungibleResourceManagerAllOf | null): any;
