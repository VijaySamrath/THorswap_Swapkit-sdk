 ...
 * @export
 */
export declare const BootLoaderModuleFieldVmBootSubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfBootLoaderModuleFieldVmBootSubstateAllOf(value: object): boolean;
export declare function BootLoaderModuleFieldVmBootSubstateAllOfFromJSON(json: any): BootLoaderModuleFieldVmBootSubstateAllOf;
export declare function BootLoaderModuleFieldVmBootSubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BootLoaderModuleFieldVmBootSubstateAllOf;
export declare function BootLoaderModuleFieldVmBootSubstateAllOfToJSON(value?: BootLoaderModuleFieldVmBootSubstateAllOf | null): any;
