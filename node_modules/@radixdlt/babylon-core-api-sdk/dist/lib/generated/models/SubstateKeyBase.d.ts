 ...
 */
export declare function instanceOfSubstateKeyBase(value: object): boolean;
export declare function SubstateKeyBaseFromJSON(json: any): SubstateKeyBase;
export declare function SubstateKeyBaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubstateKeyBase;
export declare function SubstateKeyBaseToJSON(value?: SubstateKeyBase | null): any;
