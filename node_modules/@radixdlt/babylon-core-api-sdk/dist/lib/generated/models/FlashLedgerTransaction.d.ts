 ...
 * @export
 */
export declare const FlashLedgerTransactionTypeEnum: {
 ...
 */
export declare function instanceOfFlashLedgerTransaction(value: object): boolean;
export declare function FlashLedgerTransactionFromJSON(json: any): FlashLedgerTransaction;
export declare function FlashLedgerTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlashLedgerTransaction;
export declare function FlashLedgerTransactionToJSON(value?: FlashLedgerTransaction | null): any;
