 ...
 * @export
 */
export declare const FungibleVaultFieldFrozenStatusSubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfFungibleVaultFieldFrozenStatusSubstate(value: object): boolean;
export declare function FungibleVaultFieldFrozenStatusSubstateFromJSON(json: any): FungibleVaultFieldFrozenStatusSubstate;
export declare function FungibleVaultFieldFrozenStatusSubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): FungibleVaultFieldFrozenStatusSubstate;
export declare function FungibleVaultFieldFrozenStatusSubstateToJSON(value?: FungibleVaultFieldFrozenStatusSubstate | null): any;
