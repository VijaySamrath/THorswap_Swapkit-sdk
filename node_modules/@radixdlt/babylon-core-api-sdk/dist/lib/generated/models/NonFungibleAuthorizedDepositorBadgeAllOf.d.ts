 ...
 * @export
 */
export declare const NonFungibleAuthorizedDepositorBadgeAllOfTypeEnum: {
 ...
 */
export declare function instanceOfNonFungibleAuthorizedDepositorBadgeAllOf(value: object): boolean;
export declare function NonFungibleAuthorizedDepositorBadgeAllOfFromJSON(json: any): NonFungibleAuthorizedDepositorBadgeAllOf;
export declare function NonFungibleAuthorizedDepositorBadgeAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): NonFungibleAuthorizedDepositorBadgeAllOf;
export declare function NonFungibleAuthorizedDepositorBadgeAllOfToJSON(value?: NonFungibleAuthorizedDepositorBadgeAllOf | null): any;
