 ...
 * @export
 */
export declare const ObjectInstanceTypeReferenceAllOfTypeEnum: {
 ...
 */
export declare function instanceOfObjectInstanceTypeReferenceAllOf(value: object): boolean;
export declare function ObjectInstanceTypeReferenceAllOfFromJSON(json: any): ObjectInstanceTypeReferenceAllOf;
export declare function ObjectInstanceTypeReferenceAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ObjectInstanceTypeReferenceAllOf;
export declare function ObjectInstanceTypeReferenceAllOfToJSON(value?: ObjectInstanceTypeReferenceAllOf | null): any;
