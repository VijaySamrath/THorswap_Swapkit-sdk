 ...
 * @export
 */
export declare const ConsensusLedgerProofOriginAllOfTypeEnum: {
 ...
 */
export declare function instanceOfConsensusLedgerProofOriginAllOf(value: object): boolean;
export declare function ConsensusLedgerProofOriginAllOfFromJSON(json: any): ConsensusLedgerProofOriginAllOf;
export declare function ConsensusLedgerProofOriginAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsensusLedgerProofOriginAllOf;
export declare function ConsensusLedgerProofOriginAllOfToJSON(value?: ConsensusLedgerProofOriginAllOf | null): any;
