 ...
 * @export
 */
export declare const ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate(value: object): boolean;
export declare function ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstateFromJSON(json: any): ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate;
export declare function ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate;
export declare function ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstateToJSON(value?: ConsensusManagerFieldCurrentTimeRoundedToMinutesSubstate | null): any;
