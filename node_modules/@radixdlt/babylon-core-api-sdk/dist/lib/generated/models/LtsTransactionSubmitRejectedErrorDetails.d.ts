 ...
 * @export
 */
export declare const LtsTransactionSubmitRejectedErrorDetailsTypeEnum: {
 ...
 */
export declare function instanceOfLtsTransactionSubmitRejectedErrorDetails(value: object): boolean;
export declare function LtsTransactionSubmitRejectedErrorDetailsFromJSON(json: any): LtsTransactionSubmitRejectedErrorDetails;
export declare function LtsTransactionSubmitRejectedErrorDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): LtsTransactionSubmitRejectedErrorDetails;
export declare function LtsTransactionSubmitRejectedErrorDetailsToJSON(value?: LtsTransactionSubmitRejectedErrorDetails | null): any;
