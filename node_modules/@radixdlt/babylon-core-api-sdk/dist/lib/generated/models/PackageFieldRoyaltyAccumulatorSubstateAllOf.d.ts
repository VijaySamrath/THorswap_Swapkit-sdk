 ...
 * @export
 */
export declare const PackageFieldRoyaltyAccumulatorSubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfPackageFieldRoyaltyAccumulatorSubstateAllOf(value: object): boolean;
export declare function PackageFieldRoyaltyAccumulatorSubstateAllOfFromJSON(json: any): PackageFieldRoyaltyAccumulatorSubstateAllOf;
export declare function PackageFieldRoyaltyAccumulatorSubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PackageFieldRoyaltyAccumulatorSubstateAllOf;
export declare function PackageFieldRoyaltyAccumulatorSubstateAllOfToJSON(value?: PackageFieldRoyaltyAccumulatorSubstateAllOf | null): any;
