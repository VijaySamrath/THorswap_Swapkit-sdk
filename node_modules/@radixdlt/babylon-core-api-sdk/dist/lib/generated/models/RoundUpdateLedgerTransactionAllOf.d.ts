 ...
 * @export
 */
export declare const RoundUpdateLedgerTransactionAllOfTypeEnum: {
    readonly RoundUpdate: "RoundUpdate";
};
 ...
 */
export declare function instanceOfRoundUpdateLedgerTransactionAllOf(value: object): boolean;
export declare function RoundUpdateLedgerTransactionAllOfFromJSON(json: any): RoundUpdateLedgerTransactionAllOf;
export declare function RoundUpdateLedgerTransactionAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoundUpdateLedgerTransactionAllOf;
export declare function RoundUpdateLedgerTransactionAllOfToJSON(value?: RoundUpdateLedgerTransactionAllOf | null): any;
