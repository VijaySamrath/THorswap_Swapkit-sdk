 ...
 */
export declare function instanceOfActiveValidator(value: object): boolean;
export declare function ActiveValidatorFromJSON(json: any): ActiveValidator;
export declare function ActiveValidatorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActiveValidator;
export declare function ActiveValidatorToJSON(value?: ActiveValidator | null): any;
