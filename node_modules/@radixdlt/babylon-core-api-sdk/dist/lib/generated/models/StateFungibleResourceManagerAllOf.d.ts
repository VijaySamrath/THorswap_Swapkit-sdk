 ...
 * @export
 */
export declare const StateFungibleResourceManagerAllOfResourceTypeEnum: {
 ...
 */
export declare function instanceOfStateFungibleResourceManagerAllOf(value: object): boolean;
export declare function StateFungibleResourceManagerAllOfFromJSON(json: any): StateFungibleResourceManagerAllOf;
export declare function StateFungibleResourceManagerAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): StateFungibleResourceManagerAllOf;
export declare function StateFungibleResourceManagerAllOfToJSON(value?: StateFungibleResourceManagerAllOf | null): any;
