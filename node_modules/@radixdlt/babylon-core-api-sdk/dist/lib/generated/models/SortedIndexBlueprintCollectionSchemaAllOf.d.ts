 ...
 * @export
 */
export declare const SortedIndexBlueprintCollectionSchemaAllOfTypeEnum: {
    readonly SortedIndex: "SortedIndex";
};
 ...
 */
export declare function instanceOfSortedIndexBlueprintCollectionSchemaAllOf(value: object): boolean;
export declare function SortedIndexBlueprintCollectionSchemaAllOfFromJSON(json: any): SortedIndexBlueprintCollectionSchemaAllOf;
export declare function SortedIndexBlueprintCollectionSchemaAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): SortedIndexBlueprintCollectionSchemaAllOf;
export declare function SortedIndexBlueprintCollectionSchemaAllOfToJSON(value?: SortedIndexBlueprintCollectionSchemaAllOf | null): any;
