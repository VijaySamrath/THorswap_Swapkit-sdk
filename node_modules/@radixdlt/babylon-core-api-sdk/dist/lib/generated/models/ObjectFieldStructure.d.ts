 ...
 * @export
 */
export declare const ObjectFieldStructureTypeEnum: {
 ...
 */
export declare function instanceOfObjectFieldStructure(value: object): boolean;
export declare function ObjectFieldStructureFromJSON(json: any): ObjectFieldStructure;
export declare function ObjectFieldStructureFromJSONTyped(json: any, ignoreDiscriminator: boolean): ObjectFieldStructure;
export declare function ObjectFieldStructureToJSON(value?: ObjectFieldStructure | null): any;
