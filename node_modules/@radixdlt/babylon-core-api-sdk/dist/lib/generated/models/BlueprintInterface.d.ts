...
export interface BlueprintInterface {
     ...
     */
    events: {
        [key: string]: BlueprintPayloadDef;
    };
    /**
     ...
     */
    types: {
        [key: string]: ScopedTypeId;
    };
}
/**
 * Check if a given object implements the BlueprintInterface interface.
 */
export declare function instanceOfBlueprintInterface(value: object): boolean;
export declare function BlueprintInterfaceFromJSON(json: any): BlueprintInterface;
export declare function BlueprintInterfaceFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlueprintInterface;
export declare function BlueprintInterfaceToJSON(value?: BlueprintInterface | null): any;
