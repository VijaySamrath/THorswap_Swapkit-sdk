 ...
 * @export
 */
export declare const LocalGenericSubstitutionAllOfTypeEnum: {
 ...
 */
export declare function instanceOfLocalGenericSubstitutionAllOf(value: object): boolean;
export declare function LocalGenericSubstitutionAllOfFromJSON(json: any): LocalGenericSubstitutionAllOf;
export declare function LocalGenericSubstitutionAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): LocalGenericSubstitutionAllOf;
export declare function LocalGenericSubstitutionAllOfToJSON(value?: LocalGenericSubstitutionAllOf | null): any;
