 ...
 * @export
 */
export declare const NonFungibleVaultFieldFrozenStatusSubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfNonFungibleVaultFieldFrozenStatusSubstateAllOf(value: object): boolean;
export declare function NonFungibleVaultFieldFrozenStatusSubstateAllOfFromJSON(json: any): NonFungibleVaultFieldFrozenStatusSubstateAllOf;
export declare function NonFungibleVaultFieldFrozenStatusSubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): NonFungibleVaultFieldFrozenStatusSubstateAllOf;
export declare function NonFungibleVaultFieldFrozenStatusSubstateAllOfToJSON(value?: NonFungibleVaultFieldFrozenStatusSubstateAllOf | null): any;
