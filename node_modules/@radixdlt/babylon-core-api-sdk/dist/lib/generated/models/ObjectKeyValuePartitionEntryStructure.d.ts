 ...
 * @export
 */
export declare const ObjectKeyValuePartitionEntryStructureTypeEnum: {
 ...
 */
export declare function instanceOfObjectKeyValuePartitionEntryStructure(value: object): boolean;
export declare function ObjectKeyValuePartitionEntryStructureFromJSON(json: any): ObjectKeyValuePartitionEntryStructure;
export declare function ObjectKeyValuePartitionEntryStructureFromJSONTyped(json: any, ignoreDiscriminator: boolean): ObjectKeyValuePartitionEntryStructure;
export declare function ObjectKeyValuePartitionEntryStructureToJSON(value?: ObjectKeyValuePartitionEntryStructure | null): any;
