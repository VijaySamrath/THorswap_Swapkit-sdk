 ...
 * @export
 */
export declare const ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf(value: object): boolean;
export declare function ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOfFromJSON(json: any): ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf;
export declare function ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf;
export declare function ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOfToJSON(value?: ValidatorFieldProtocolUpdateReadinessSignalSubstateAllOf | null): any;
