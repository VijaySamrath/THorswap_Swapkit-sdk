 ...
 */
export declare function instanceOfEncryptedMessageCurveDecryptorSet(value: object): boolean;
export declare function EncryptedMessageCurveDecryptorSetFromJSON(json: any): EncryptedMessageCurveDecryptorSet;
export declare function EncryptedMessageCurveDecryptorSetFromJSONTyped(json: any, ignoreDiscriminator: boolean): EncryptedMessageCurveDecryptorSet;
export declare function EncryptedMessageCurveDecryptorSetToJSON(value?: EncryptedMessageCurveDecryptorSet | null): any;
