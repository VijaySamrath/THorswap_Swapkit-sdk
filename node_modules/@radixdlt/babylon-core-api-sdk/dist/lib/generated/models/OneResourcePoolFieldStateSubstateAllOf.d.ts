 ...
 * @export
 */
export declare const OneResourcePoolFieldStateSubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfOneResourcePoolFieldStateSubstateAllOf(value: object): boolean;
export declare function OneResourcePoolFieldStateSubstateAllOfFromJSON(json: any): OneResourcePoolFieldStateSubstateAllOf;
export declare function OneResourcePoolFieldStateSubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): OneResourcePoolFieldStateSubstateAllOf;
export declare function OneResourcePoolFieldStateSubstateAllOfToJSON(value?: OneResourcePoolFieldStateSubstateAllOf | null): any;
