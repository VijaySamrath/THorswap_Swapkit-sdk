 ...
 * @export
 */
export declare const FungibleVaultFieldFrozenStatusSubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfFungibleVaultFieldFrozenStatusSubstateAllOf(value: object): boolean;
export declare function FungibleVaultFieldFrozenStatusSubstateAllOfFromJSON(json: any): FungibleVaultFieldFrozenStatusSubstateAllOf;
export declare function FungibleVaultFieldFrozenStatusSubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): FungibleVaultFieldFrozenStatusSubstateAllOf;
export declare function FungibleVaultFieldFrozenStatusSubstateAllOfToJSON(value?: FungibleVaultFieldFrozenStatusSubstateAllOf | null): any;
