 ...
 * @export
 */
export declare const NonFungibleVaultContentsIndexEntrySubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfNonFungibleVaultContentsIndexEntrySubstate(value: object): boolean;
export declare function NonFungibleVaultContentsIndexEntrySubstateFromJSON(json: any): NonFungibleVaultContentsIndexEntrySubstate;
export declare function NonFungibleVaultContentsIndexEntrySubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): NonFungibleVaultContentsIndexEntrySubstate;
export declare function NonFungibleVaultContentsIndexEntrySubstateToJSON(value?: NonFungibleVaultContentsIndexEntrySubstate | null): any;
