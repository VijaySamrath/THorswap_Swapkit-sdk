 ...
 * @export
 */
export declare const FlashLedgerTransactionAllOfTypeEnum: {
 ...
 */
export declare function instanceOfFlashLedgerTransactionAllOf(value: object): boolean;
export declare function FlashLedgerTransactionAllOfFromJSON(json: any): FlashLedgerTransactionAllOf;
export declare function FlashLedgerTransactionAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlashLedgerTransactionAllOf;
export declare function FlashLedgerTransactionAllOfToJSON(value?: FlashLedgerTransactionAllOf | null): any;
