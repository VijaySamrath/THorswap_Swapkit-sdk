 ...
 */
export declare function instanceOfSubstateValue(value: object): boolean;
export declare function SubstateValueFromJSON(json: any): SubstateValue;
export declare function SubstateValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubstateValue;
export declare function SubstateValueToJSON(value?: SubstateValue | null): any;
