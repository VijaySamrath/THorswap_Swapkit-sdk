 ...
 * @export
 */
export declare const ConsensusLedgerProofOriginTypeEnum: {
 ...
 */
export declare function instanceOfConsensusLedgerProofOrigin(value: object): boolean;
export declare function ConsensusLedgerProofOriginFromJSON(json: any): ConsensusLedgerProofOrigin;
export declare function ConsensusLedgerProofOriginFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsensusLedgerProofOrigin;
export declare function ConsensusLedgerProofOriginToJSON(value?: ConsensusLedgerProofOrigin | null): any;
