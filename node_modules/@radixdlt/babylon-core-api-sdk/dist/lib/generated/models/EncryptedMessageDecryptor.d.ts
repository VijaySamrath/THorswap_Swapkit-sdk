 ...
 */
export declare function instanceOfEncryptedMessageDecryptor(value: object): boolean;
export declare function EncryptedMessageDecryptorFromJSON(json: any): EncryptedMessageDecryptor;
export declare function EncryptedMessageDecryptorFromJSONTyped(json: any, ignoreDiscriminator: boolean): EncryptedMessageDecryptor;
export declare function EncryptedMessageDecryptorToJSON(value?: EncryptedMessageDecryptor | null): any;
