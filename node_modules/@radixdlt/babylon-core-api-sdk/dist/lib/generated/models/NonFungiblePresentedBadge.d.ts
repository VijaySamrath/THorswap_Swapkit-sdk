 ...
 * @export
 */
export declare const NonFungiblePresentedBadgeTypeEnum: {
 ...
 */
export declare function instanceOfNonFungiblePresentedBadge(value: object): boolean;
export declare function NonFungiblePresentedBadgeFromJSON(json: any): NonFungiblePresentedBadge;
export declare function NonFungiblePresentedBadgeFromJSONTyped(json: any, ignoreDiscriminator: boolean): NonFungiblePresentedBadge;
export declare function NonFungiblePresentedBadgeToJSON(value?: NonFungiblePresentedBadge | null): any;
