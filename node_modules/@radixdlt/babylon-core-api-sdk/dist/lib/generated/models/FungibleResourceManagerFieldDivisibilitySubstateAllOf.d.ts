 ...
 * @export
 */
export declare const FungibleResourceManagerFieldDivisibilitySubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfFungibleResourceManagerFieldDivisibilitySubstateAllOf(value: object): boolean;
export declare function FungibleResourceManagerFieldDivisibilitySubstateAllOfFromJSON(json: any): FungibleResourceManagerFieldDivisibilitySubstateAllOf;
export declare function FungibleResourceManagerFieldDivisibilitySubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): FungibleResourceManagerFieldDivisibilitySubstateAllOf;
export declare function FungibleResourceManagerFieldDivisibilitySubstateAllOfToJSON(value?: FungibleResourceManagerFieldDivisibilitySubstateAllOf | null): any;
