 ...
 * @export
 */
export declare const TransactionSubmitErrorResponseAllOfErrorTypeEnum: {
    readonly TransactionSubmit: "TransactionSubmit";
};
 ...
 */
export declare function instanceOfTransactionSubmitErrorResponseAllOf(value: object): boolean;
export declare function TransactionSubmitErrorResponseAllOfFromJSON(json: any): TransactionSubmitErrorResponseAllOf;
export declare function TransactionSubmitErrorResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionSubmitErrorResponseAllOf;
export declare function TransactionSubmitErrorResponseAllOfToJSON(value?: TransactionSubmitErrorResponseAllOf | null): any;
