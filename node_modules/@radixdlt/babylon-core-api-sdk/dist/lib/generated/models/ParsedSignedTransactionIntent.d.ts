 ...
 * @export
 */
export declare const ParsedSignedTransactionIntentTypeEnum: {
 ...
 */
export declare function instanceOfParsedSignedTransactionIntent(value: object): boolean;
export declare function ParsedSignedTransactionIntentFromJSON(json: any): ParsedSignedTransactionIntent;
export declare function ParsedSignedTransactionIntentFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParsedSignedTransactionIntent;
export declare function ParsedSignedTransactionIntentToJSON(value?: ParsedSignedTransactionIntent | null): any;
