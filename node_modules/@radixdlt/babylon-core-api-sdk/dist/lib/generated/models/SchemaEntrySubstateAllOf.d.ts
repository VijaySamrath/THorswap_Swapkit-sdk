 ...
 * @export
 */
export declare const SchemaEntrySubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfSchemaEntrySubstateAllOf(value: object): boolean;
export declare function SchemaEntrySubstateAllOfFromJSON(json: any): SchemaEntrySubstateAllOf;
export declare function SchemaEntrySubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): SchemaEntrySubstateAllOf;
export declare function SchemaEntrySubstateAllOfToJSON(value?: SchemaEntrySubstateAllOf | null): any;
