 ...
 * @export
 */
export declare const ConsensusManagerFieldConfigSubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfConsensusManagerFieldConfigSubstate(value: object): boolean;
export declare function ConsensusManagerFieldConfigSubstateFromJSON(json: any): ConsensusManagerFieldConfigSubstate;
export declare function ConsensusManagerFieldConfigSubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsensusManagerFieldConfigSubstate;
export declare function ConsensusManagerFieldConfigSubstateToJSON(value?: ConsensusManagerFieldConfigSubstate | null): any;
