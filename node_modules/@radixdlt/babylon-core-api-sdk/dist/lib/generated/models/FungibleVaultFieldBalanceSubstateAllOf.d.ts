 ...
 * @export
 */
export declare const FungibleVaultFieldBalanceSubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfFungibleVaultFieldBalanceSubstateAllOf(value: object): boolean;
export declare function FungibleVaultFieldBalanceSubstateAllOfFromJSON(json: any): FungibleVaultFieldBalanceSubstateAllOf;
export declare function FungibleVaultFieldBalanceSubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): FungibleVaultFieldBalanceSubstateAllOf;
export declare function FungibleVaultFieldBalanceSubstateAllOfToJSON(value?: FungibleVaultFieldBalanceSubstateAllOf | null): any;
