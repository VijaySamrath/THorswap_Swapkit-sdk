 ...
 * @export
 */
export declare const AccessControllerFieldStateSubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfAccessControllerFieldStateSubstate(value: object): boolean;
export declare function AccessControllerFieldStateSubstateFromJSON(json: any): AccessControllerFieldStateSubstate;
export declare function AccessControllerFieldStateSubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccessControllerFieldStateSubstate;
export declare function AccessControllerFieldStateSubstateToJSON(value?: AccessControllerFieldStateSubstate | null): any;
