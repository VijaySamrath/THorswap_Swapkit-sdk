 ...
 * @export
 */
export declare const TwoResourcePoolFieldStateSubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfTwoResourcePoolFieldStateSubstateAllOf(value: object): boolean;
export declare function TwoResourcePoolFieldStateSubstateAllOfFromJSON(json: any): TwoResourcePoolFieldStateSubstateAllOf;
export declare function TwoResourcePoolFieldStateSubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): TwoResourcePoolFieldStateSubstateAllOf;
export declare function TwoResourcePoolFieldStateSubstateAllOfToJSON(value?: TwoResourcePoolFieldStateSubstateAllOf | null): any;
