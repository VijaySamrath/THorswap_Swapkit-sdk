 ...
 */
export declare function instanceOfParsedNotarizedTransactionAllOfValidationError(value: object): boolean;
export declare function ParsedNotarizedTransactionAllOfValidationErrorFromJSON(json: any): ParsedNotarizedTransactionAllOfValidationError;
export declare function ParsedNotarizedTransactionAllOfValidationErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParsedNotarizedTransactionAllOfValidationError;
export declare function ParsedNotarizedTransactionAllOfValidationErrorToJSON(value?: ParsedNotarizedTransactionAllOfValidationError | null): any;
