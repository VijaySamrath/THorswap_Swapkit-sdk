 ...
 * @export
 */
export declare const PackageCodeVmTypeEntrySubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfPackageCodeVmTypeEntrySubstateAllOf(value: object): boolean;
export declare function PackageCodeVmTypeEntrySubstateAllOfFromJSON(json: any): PackageCodeVmTypeEntrySubstateAllOf;
export declare function PackageCodeVmTypeEntrySubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PackageCodeVmTypeEntrySubstateAllOf;
export declare function PackageCodeVmTypeEntrySubstateAllOfToJSON(value?: PackageCodeVmTypeEntrySubstateAllOf | null): any;
