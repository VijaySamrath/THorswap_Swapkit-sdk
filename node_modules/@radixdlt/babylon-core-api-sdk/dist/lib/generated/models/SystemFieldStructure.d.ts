 ...
 * @export
 */
export declare const SystemFieldStructureTypeEnum: {
 ...
 */
export declare function instanceOfSystemFieldStructure(value: object): boolean;
export declare function SystemFieldStructureFromJSON(json: any): SystemFieldStructure;
export declare function SystemFieldStructureFromJSONTyped(json: any, ignoreDiscriminator: boolean): SystemFieldStructure;
export declare function SystemFieldStructureToJSON(value?: SystemFieldStructure | null): any;
