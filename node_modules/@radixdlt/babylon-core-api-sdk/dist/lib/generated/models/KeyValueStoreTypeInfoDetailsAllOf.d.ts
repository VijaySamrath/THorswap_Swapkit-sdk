 ...
 * @export
 */
export declare const KeyValueStoreTypeInfoDetailsAllOfTypeEnum: {
 ...
 */
export declare function instanceOfKeyValueStoreTypeInfoDetailsAllOf(value: object): boolean;
export declare function KeyValueStoreTypeInfoDetailsAllOfFromJSON(json: any): KeyValueStoreTypeInfoDetailsAllOf;
export declare function KeyValueStoreTypeInfoDetailsAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): KeyValueStoreTypeInfoDetailsAllOf;
export declare function KeyValueStoreTypeInfoDetailsAllOfToJSON(value?: KeyValueStoreTypeInfoDetailsAllOf | null): any;
