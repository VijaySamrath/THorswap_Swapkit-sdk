 ...
 * @export
 */
export declare const FungibleResourceManagerFieldDivisibilitySubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfFungibleResourceManagerFieldDivisibilitySubstate(value: object): boolean;
export declare function FungibleResourceManagerFieldDivisibilitySubstateFromJSON(json: any): FungibleResourceManagerFieldDivisibilitySubstate;
export declare function FungibleResourceManagerFieldDivisibilitySubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): FungibleResourceManagerFieldDivisibilitySubstate;
export declare function FungibleResourceManagerFieldDivisibilitySubstateToJSON(value?: FungibleResourceManagerFieldDivisibilitySubstate | null): any;
