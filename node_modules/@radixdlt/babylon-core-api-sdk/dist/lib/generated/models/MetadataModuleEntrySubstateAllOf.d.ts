 ...
 * @export
 */
export declare const MetadataModuleEntrySubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfMetadataModuleEntrySubstateAllOf(value: object): boolean;
export declare function MetadataModuleEntrySubstateAllOfFromJSON(json: any): MetadataModuleEntrySubstateAllOf;
export declare function MetadataModuleEntrySubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetadataModuleEntrySubstateAllOf;
export declare function MetadataModuleEntrySubstateAllOfToJSON(value?: MetadataModuleEntrySubstateAllOf | null): any;
