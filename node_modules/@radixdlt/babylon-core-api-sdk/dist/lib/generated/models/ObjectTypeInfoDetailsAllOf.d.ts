 ...
 * @export
 */
export declare const ObjectTypeInfoDetailsAllOfTypeEnum: {
 ...
 */
export declare function instanceOfObjectTypeInfoDetailsAllOf(value: object): boolean;
export declare function ObjectTypeInfoDetailsAllOfFromJSON(json: any): ObjectTypeInfoDetailsAllOf;
export declare function ObjectTypeInfoDetailsAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ObjectTypeInfoDetailsAllOf;
export declare function ObjectTypeInfoDetailsAllOfToJSON(value?: ObjectTypeInfoDetailsAllOf | null): any;
