 ...
 * @export
 */
export declare const PackageCodeOriginalCodeEntrySubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfPackageCodeOriginalCodeEntrySubstate(value: object): boolean;
export declare function PackageCodeOriginalCodeEntrySubstateFromJSON(json: any): PackageCodeOriginalCodeEntrySubstate;
export declare function PackageCodeOriginalCodeEntrySubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): PackageCodeOriginalCodeEntrySubstate;
export declare function PackageCodeOriginalCodeEntrySubstateToJSON(value?: PackageCodeOriginalCodeEntrySubstate | null): any;
