 ...
 * @export
 */
export declare const FungibleResourceManagerFieldTotalSupplySubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfFungibleResourceManagerFieldTotalSupplySubstateAllOf(value: object): boolean;
export declare function FungibleResourceManagerFieldTotalSupplySubstateAllOfFromJSON(json: any): FungibleResourceManagerFieldTotalSupplySubstateAllOf;
export declare function FungibleResourceManagerFieldTotalSupplySubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): FungibleResourceManagerFieldTotalSupplySubstateAllOf;
export declare function FungibleResourceManagerFieldTotalSupplySubstateAllOfToJSON(value?: FungibleResourceManagerFieldTotalSupplySubstateAllOf | null): any;
