 ...
 * @export
 */
export declare const SortedIndexBlueprintCollectionSchemaTypeEnum: {
 ...
 */
export declare function instanceOfSortedIndexBlueprintCollectionSchema(value: object): boolean;
export declare function SortedIndexBlueprintCollectionSchemaFromJSON(json: any): SortedIndexBlueprintCollectionSchema;
export declare function SortedIndexBlueprintCollectionSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): SortedIndexBlueprintCollectionSchema;
export declare function SortedIndexBlueprintCollectionSchemaToJSON(value?: SortedIndexBlueprintCollectionSchema | null): any;
