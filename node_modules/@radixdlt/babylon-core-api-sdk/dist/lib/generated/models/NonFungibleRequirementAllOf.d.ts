 ...
 * @export
 */
export declare const NonFungibleRequirementAllOfTypeEnum: {
 ...
 */
export declare function instanceOfNonFungibleRequirementAllOf(value: object): boolean;
export declare function NonFungibleRequirementAllOfFromJSON(json: any): NonFungibleRequirementAllOf;
export declare function NonFungibleRequirementAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): NonFungibleRequirementAllOf;
export declare function NonFungibleRequirementAllOfToJSON(value?: NonFungibleRequirementAllOf | null): any;
