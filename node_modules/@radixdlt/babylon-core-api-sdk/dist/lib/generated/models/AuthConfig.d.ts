 ...
 */
export declare function instanceOfAuthConfig(value: object): boolean;
export declare function AuthConfigFromJSON(json: any): AuthConfig;
export declare function AuthConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthConfig;
export declare function AuthConfigToJSON(value?: AuthConfig | null): any;
