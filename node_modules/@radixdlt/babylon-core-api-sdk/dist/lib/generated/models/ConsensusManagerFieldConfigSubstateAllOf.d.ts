 ...
 * @export
 */
export declare const ConsensusManagerFieldConfigSubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfConsensusManagerFieldConfigSubstateAllOf(value: object): boolean;
export declare function ConsensusManagerFieldConfigSubstateAllOfFromJSON(json: any): ConsensusManagerFieldConfigSubstateAllOf;
export declare function ConsensusManagerFieldConfigSubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsensusManagerFieldConfigSubstateAllOf;
export declare function ConsensusManagerFieldConfigSubstateAllOfToJSON(value?: ConsensusManagerFieldConfigSubstateAllOf | null): any;
