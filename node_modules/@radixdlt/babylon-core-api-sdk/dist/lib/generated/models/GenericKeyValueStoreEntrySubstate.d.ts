 ...
 * @export
 */
export declare const GenericKeyValueStoreEntrySubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfGenericKeyValueStoreEntrySubstate(value: object): boolean;
export declare function GenericKeyValueStoreEntrySubstateFromJSON(json: any): GenericKeyValueStoreEntrySubstate;
export declare function GenericKeyValueStoreEntrySubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericKeyValueStoreEntrySubstate;
export declare function GenericKeyValueStoreEntrySubstateToJSON(value?: GenericKeyValueStoreEntrySubstate | null): any;
