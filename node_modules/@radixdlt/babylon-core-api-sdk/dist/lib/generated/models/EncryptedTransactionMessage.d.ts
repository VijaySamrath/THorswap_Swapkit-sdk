 ...
 * @export
 */
export declare const EncryptedTransactionMessageTypeEnum: {
 ...
 */
export declare function instanceOfEncryptedTransactionMessage(value: object): boolean;
export declare function EncryptedTransactionMessageFromJSON(json: any): EncryptedTransactionMessage;
export declare function EncryptedTransactionMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): EncryptedTransactionMessage;
export declare function EncryptedTransactionMessageToJSON(value?: EncryptedTransactionMessage | null): any;
