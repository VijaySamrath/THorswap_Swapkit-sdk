 ...
 * @export
 */
export declare const EcdsaSecp256k1SignatureAllOfKeyTypeEnum: {
 ...
 */
export declare function instanceOfEcdsaSecp256k1SignatureAllOf(value: object): boolean;
export declare function EcdsaSecp256k1SignatureAllOfFromJSON(json: any): EcdsaSecp256k1SignatureAllOf;
export declare function EcdsaSecp256k1SignatureAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): EcdsaSecp256k1SignatureAllOf;
export declare function EcdsaSecp256k1SignatureAllOfToJSON(value?: EcdsaSecp256k1SignatureAllOf | null): any;
