 ...
 * @export
 */
export declare const PlaintextTransactionMessageAllOfTypeEnum: {
 ...
 */
export declare function instanceOfPlaintextTransactionMessageAllOf(value: object): boolean;
export declare function PlaintextTransactionMessageAllOfFromJSON(json: any): PlaintextTransactionMessageAllOf;
export declare function PlaintextTransactionMessageAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlaintextTransactionMessageAllOf;
export declare function PlaintextTransactionMessageAllOfToJSON(value?: PlaintextTransactionMessageAllOf | null): any;
