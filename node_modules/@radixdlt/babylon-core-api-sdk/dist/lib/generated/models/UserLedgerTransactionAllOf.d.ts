 ...
 * @export
 */
export declare const UserLedgerTransactionAllOfTypeEnum: {
    readonly User: "User";
};
 ...
 */
export declare function instanceOfUserLedgerTransactionAllOf(value: object): boolean;
export declare function UserLedgerTransactionAllOfFromJSON(json: any): UserLedgerTransactionAllOf;
export declare function UserLedgerTransactionAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserLedgerTransactionAllOf;
export declare function UserLedgerTransactionAllOfToJSON(value?: UserLedgerTransactionAllOf | null): any;
