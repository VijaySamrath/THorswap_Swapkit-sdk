 ...
 * @export
 */
export declare const LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOfTypeEnum: {
    readonly PriorityThresholdNotMet: "PriorityThresholdNotMet";
};
 ...
 */
export declare function instanceOfLtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOf(value: object): boolean;
export declare function LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOfFromJSON(json: any): LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOf;
export declare function LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOf;
export declare function LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOfToJSON(value?: LtsTransactionSubmitPriorityThresholdNotMetErrorDetailsAllOf | null): any;
