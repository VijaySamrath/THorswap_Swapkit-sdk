 ...
 * @export
 */
export declare const LtsTransactionSubmitErrorResponseAllOfErrorTypeEnum: {
    readonly LtsTransactionSubmit: "LtsTransactionSubmit";
};
 ...
 */
export declare function instanceOfLtsTransactionSubmitErrorResponseAllOf(value: object): boolean;
export declare function LtsTransactionSubmitErrorResponseAllOfFromJSON(json: any): LtsTransactionSubmitErrorResponseAllOf;
export declare function LtsTransactionSubmitErrorResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): LtsTransactionSubmitErrorResponseAllOf;
export declare function LtsTransactionSubmitErrorResponseAllOfToJSON(value?: LtsTransactionSubmitErrorResponseAllOf | null): any;
