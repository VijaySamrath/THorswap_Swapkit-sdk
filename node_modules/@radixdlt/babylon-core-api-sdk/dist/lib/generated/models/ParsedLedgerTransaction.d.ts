 ...
 * @export
 */
export declare const ParsedLedgerTransactionTypeEnum: {
 ...
 */
export declare function instanceOfParsedLedgerTransaction(value: object): boolean;
export declare function ParsedLedgerTransactionFromJSON(json: any): ParsedLedgerTransaction;
export declare function ParsedLedgerTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParsedLedgerTransaction;
export declare function ParsedLedgerTransactionToJSON(value?: ParsedLedgerTransaction | null): any;
