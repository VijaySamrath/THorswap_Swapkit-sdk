 ...
 * @export
 */
export declare const AccountResourcePreferenceEntrySubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfAccountResourcePreferenceEntrySubstateAllOf(value: object): boolean;
export declare function AccountResourcePreferenceEntrySubstateAllOfFromJSON(json: any): AccountResourcePreferenceEntrySubstateAllOf;
export declare function AccountResourcePreferenceEntrySubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountResourcePreferenceEntrySubstateAllOf;
export declare function AccountResourcePreferenceEntrySubstateAllOfToJSON(value?: AccountResourcePreferenceEntrySubstateAllOf | null): any;
