 ...
 * @export
 */
export declare const KeyValueBlueprintCollectionSchemaAllOfTypeEnum: {
 ...
 */
export declare function instanceOfKeyValueBlueprintCollectionSchemaAllOf(value: object): boolean;
export declare function KeyValueBlueprintCollectionSchemaAllOfFromJSON(json: any): KeyValueBlueprintCollectionSchemaAllOf;
export declare function KeyValueBlueprintCollectionSchemaAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): KeyValueBlueprintCollectionSchemaAllOf;
export declare function KeyValueBlueprintCollectionSchemaAllOfToJSON(value?: KeyValueBlueprintCollectionSchemaAllOf | null): any;
