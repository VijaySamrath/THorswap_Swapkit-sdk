 ...
 * @export
 */
export declare const GenesisLedgerTransactionTypeEnum: {
 ...
 */
export declare function instanceOfGenesisLedgerTransaction(value: object): boolean;
export declare function GenesisLedgerTransactionFromJSON(json: any): GenesisLedgerTransaction;
export declare function GenesisLedgerTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenesisLedgerTransaction;
export declare function GenesisLedgerTransactionToJSON(value?: GenesisLedgerTransaction | null): any;
