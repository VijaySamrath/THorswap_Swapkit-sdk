 ...
 */
export declare function instanceOfScopedTypeId(value: object): boolean;
export declare function ScopedTypeIdFromJSON(json: any): ScopedTypeId;
export declare function ScopedTypeIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScopedTypeId;
export declare function ScopedTypeIdToJSON(value?: ScopedTypeId | null): any;
