 ...
 * @export
 */
export declare const MethodEventEmitterIdentifierAllOfTypeEnum: {
 ...
 */
export declare function instanceOfMethodEventEmitterIdentifierAllOf(value: object): boolean;
export declare function MethodEventEmitterIdentifierAllOfFromJSON(json: any): MethodEventEmitterIdentifierAllOf;
export declare function MethodEventEmitterIdentifierAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): MethodEventEmitterIdentifierAllOf;
export declare function MethodEventEmitterIdentifierAllOfToJSON(value?: MethodEventEmitterIdentifierAllOf | null): any;
