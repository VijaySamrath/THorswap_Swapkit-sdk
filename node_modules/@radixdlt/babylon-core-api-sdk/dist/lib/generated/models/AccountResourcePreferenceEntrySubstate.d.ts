 ...
 * @export
 */
export declare const AccountResourcePreferenceEntrySubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfAccountResourcePreferenceEntrySubstate(value: object): boolean;
export declare function AccountResourcePreferenceEntrySubstateFromJSON(json: any): AccountResourcePreferenceEntrySubstate;
export declare function AccountResourcePreferenceEntrySubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountResourcePreferenceEntrySubstate;
export declare function AccountResourcePreferenceEntrySubstateToJSON(value?: AccountResourcePreferenceEntrySubstate | null): any;
