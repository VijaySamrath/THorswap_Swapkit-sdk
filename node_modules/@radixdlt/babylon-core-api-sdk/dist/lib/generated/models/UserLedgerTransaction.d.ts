 ...
 * @export
 */
export declare const UserLedgerTransactionTypeEnum: {
    readonly User: "User";
};
 ...
 */
export declare function instanceOfUserLedgerTransaction(value: object): boolean;
export declare function UserLedgerTransactionFromJSON(json: any): UserLedgerTransaction;
export declare function UserLedgerTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserLedgerTransaction;
export declare function UserLedgerTransactionToJSON(value?: UserLedgerTransaction | null): any;
