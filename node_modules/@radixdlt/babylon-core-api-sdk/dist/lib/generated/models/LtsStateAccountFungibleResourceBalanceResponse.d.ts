 ...
 */
export declare function instanceOfLtsStateAccountFungibleResourceBalanceResponse(value: object): boolean;
export declare function LtsStateAccountFungibleResourceBalanceResponseFromJSON(json: any): LtsStateAccountFungibleResourceBalanceResponse;
export declare function LtsStateAccountFungibleResourceBalanceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LtsStateAccountFungibleResourceBalanceResponse;
export declare function LtsStateAccountFungibleResourceBalanceResponseToJSON(value?: LtsStateAccountFungibleResourceBalanceResponse | null): any;
