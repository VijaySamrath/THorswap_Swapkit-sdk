 ...
 */
export declare function instanceOfParsedSignedTransactionIntentIdentifiers(value: object): boolean;
export declare function ParsedSignedTransactionIntentIdentifiersFromJSON(json: any): ParsedSignedTransactionIntentIdentifiers;
export declare function ParsedSignedTransactionIntentIdentifiersFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParsedSignedTransactionIntentIdentifiers;
export declare function ParsedSignedTransactionIntentIdentifiersToJSON(value?: ParsedSignedTransactionIntentIdentifiers | null): any;
