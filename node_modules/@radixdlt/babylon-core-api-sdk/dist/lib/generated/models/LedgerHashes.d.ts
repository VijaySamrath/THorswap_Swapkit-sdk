 ...
 */
export declare function instanceOfLedgerHashes(value: object): boolean;
export declare function LedgerHashesFromJSON(json: any): LedgerHashes;
export declare function LedgerHashesFromJSONTyped(json: any, ignoreDiscriminator: boolean): LedgerHashes;
export declare function LedgerHashesToJSON(value?: LedgerHashes | null): any;
