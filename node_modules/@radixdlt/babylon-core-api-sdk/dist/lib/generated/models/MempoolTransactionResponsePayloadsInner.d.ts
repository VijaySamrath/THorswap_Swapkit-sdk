 ...
 */
export declare function instanceOfMempoolTransactionResponsePayloadsInner(value: object): boolean;
export declare function MempoolTransactionResponsePayloadsInnerFromJSON(json: any): MempoolTransactionResponsePayloadsInner;
export declare function MempoolTransactionResponsePayloadsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): MempoolTransactionResponsePayloadsInner;
export declare function MempoolTransactionResponsePayloadsInnerToJSON(value?: MempoolTransactionResponsePayloadsInner | null): any;
