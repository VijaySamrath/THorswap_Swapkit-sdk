 ...
 * @export
 */
export declare const PackageCodeVmTypeEntrySubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfPackageCodeVmTypeEntrySubstate(value: object): boolean;
export declare function PackageCodeVmTypeEntrySubstateFromJSON(json: any): PackageCodeVmTypeEntrySubstate;
export declare function PackageCodeVmTypeEntrySubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): PackageCodeVmTypeEntrySubstate;
export declare function PackageCodeVmTypeEntrySubstateToJSON(value?: PackageCodeVmTypeEntrySubstate | null): any;
