 ...
 * @export
 */
export declare const MethodEventEmitterIdentifierTypeEnum: {
 ...
 */
export declare function instanceOfMethodEventEmitterIdentifier(value: object): boolean;
export declare function MethodEventEmitterIdentifierFromJSON(json: any): MethodEventEmitterIdentifier;
export declare function MethodEventEmitterIdentifierFromJSONTyped(json: any, ignoreDiscriminator: boolean): MethodEventEmitterIdentifier;
export declare function MethodEventEmitterIdentifierToJSON(value?: MethodEventEmitterIdentifier | null): any;
