 ...
 * @export
 */
export declare const PackageCodeInstrumentedCodeEntrySubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfPackageCodeInstrumentedCodeEntrySubstate(value: object): boolean;
export declare function PackageCodeInstrumentedCodeEntrySubstateFromJSON(json: any): PackageCodeInstrumentedCodeEntrySubstate;
export declare function PackageCodeInstrumentedCodeEntrySubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): PackageCodeInstrumentedCodeEntrySubstate;
export declare function PackageCodeInstrumentedCodeEntrySubstateToJSON(value?: PackageCodeInstrumentedCodeEntrySubstate | null): any;
