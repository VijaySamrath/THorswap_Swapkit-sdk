 ...
 * @export
 */
export declare const ParsedSignedTransactionIntentAllOfTypeEnum: {
    readonly SignedTransactionIntent: "SignedTransactionIntent";
};
 ...
 */
export declare function instanceOfParsedSignedTransactionIntentAllOf(value: object): boolean;
export declare function ParsedSignedTransactionIntentAllOfFromJSON(json: any): ParsedSignedTransactionIntentAllOf;
export declare function ParsedSignedTransactionIntentAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParsedSignedTransactionIntentAllOf;
export declare function ParsedSignedTransactionIntentAllOfToJSON(value?: ParsedSignedTransactionIntentAllOf | null): any;
