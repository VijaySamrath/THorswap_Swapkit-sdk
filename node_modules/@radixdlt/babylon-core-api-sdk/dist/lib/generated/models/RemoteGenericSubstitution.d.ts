 ...
 * @export
 */
export declare const RemoteGenericSubstitutionTypeEnum: {
 ...
 */
export declare function instanceOfRemoteGenericSubstitution(value: object): boolean;
export declare function RemoteGenericSubstitutionFromJSON(json: any): RemoteGenericSubstitution;
export declare function RemoteGenericSubstitutionFromJSONTyped(json: any, ignoreDiscriminator: boolean): RemoteGenericSubstitution;
export declare function RemoteGenericSubstitutionToJSON(value?: RemoteGenericSubstitution | null): any;
