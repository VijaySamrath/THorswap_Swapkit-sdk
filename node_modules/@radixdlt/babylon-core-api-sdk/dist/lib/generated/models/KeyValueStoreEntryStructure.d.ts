 ...
 * @export
 */
export declare const KeyValueStoreEntryStructureTypeEnum: {
 ...
 */
export declare function instanceOfKeyValueStoreEntryStructure(value: object): boolean;
export declare function KeyValueStoreEntryStructureFromJSON(json: any): KeyValueStoreEntryStructure;
export declare function KeyValueStoreEntryStructureFromJSONTyped(json: any, ignoreDiscriminator: boolean): KeyValueStoreEntryStructure;
export declare function KeyValueStoreEntryStructureToJSON(value?: KeyValueStoreEntryStructure | null): any;
