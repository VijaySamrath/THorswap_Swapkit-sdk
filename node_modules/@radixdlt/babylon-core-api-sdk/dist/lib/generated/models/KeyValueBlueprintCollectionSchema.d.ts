 ...
 * @export
 */
export declare const KeyValueBlueprintCollectionSchemaTypeEnum: {
 ...
 */
export declare function instanceOfKeyValueBlueprintCollectionSchema(value: object): boolean;
export declare function KeyValueBlueprintCollectionSchemaFromJSON(json: any): KeyValueBlueprintCollectionSchema;
export declare function KeyValueBlueprintCollectionSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): KeyValueBlueprintCollectionSchema;
export declare function KeyValueBlueprintCollectionSchemaToJSON(value?: KeyValueBlueprintCollectionSchema | null): any;
