 ...
 * @export
 */
export declare const RoleAssignmentModuleRuleEntrySubstateSubstateTypeEnum: {
 ...
 */
export declare function instanceOfRoleAssignmentModuleRuleEntrySubstate(value: object): boolean;
export declare function RoleAssignmentModuleRuleEntrySubstateFromJSON(json: any): RoleAssignmentModuleRuleEntrySubstate;
export declare function RoleAssignmentModuleRuleEntrySubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoleAssignmentModuleRuleEntrySubstate;
export declare function RoleAssignmentModuleRuleEntrySubstateToJSON(value?: RoleAssignmentModuleRuleEntrySubstate | null): any;
