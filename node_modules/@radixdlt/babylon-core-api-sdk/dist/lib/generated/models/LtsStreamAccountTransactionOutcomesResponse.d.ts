 ...
 */
export declare function instanceOfLtsStreamAccountTransactionOutcomesResponse(value: object): boolean;
export declare function LtsStreamAccountTransactionOutcomesResponseFromJSON(json: any): LtsStreamAccountTransactionOutcomesResponse;
export declare function LtsStreamAccountTransactionOutcomesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LtsStreamAccountTransactionOutcomesResponse;
export declare function LtsStreamAccountTransactionOutcomesResponseToJSON(value?: LtsStreamAccountTransactionOutcomesResponse | null): any;
