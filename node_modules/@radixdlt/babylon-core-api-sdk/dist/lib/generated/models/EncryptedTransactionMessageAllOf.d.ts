 ...
 * @export
 */
export declare const EncryptedTransactionMessageAllOfTypeEnum: {
 ...
 */
export declare function instanceOfEncryptedTransactionMessageAllOf(value: object): boolean;
export declare function EncryptedTransactionMessageAllOfFromJSON(json: any): EncryptedTransactionMessageAllOf;
export declare function EncryptedTransactionMessageAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): EncryptedTransactionMessageAllOf;
export declare function EncryptedTransactionMessageAllOfToJSON(value?: EncryptedTransactionMessageAllOf | null): any;
