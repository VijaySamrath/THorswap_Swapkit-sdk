 ...
 * @export
 */
export declare const RoleAssignmentModuleRuleEntrySubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfRoleAssignmentModuleRuleEntrySubstateAllOf(value: object): boolean;
export declare function RoleAssignmentModuleRuleEntrySubstateAllOfFromJSON(json: any): RoleAssignmentModuleRuleEntrySubstateAllOf;
export declare function RoleAssignmentModuleRuleEntrySubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoleAssignmentModuleRuleEntrySubstateAllOf;
export declare function RoleAssignmentModuleRuleEntrySubstateAllOfToJSON(value?: RoleAssignmentModuleRuleEntrySubstateAllOf | null): any;
