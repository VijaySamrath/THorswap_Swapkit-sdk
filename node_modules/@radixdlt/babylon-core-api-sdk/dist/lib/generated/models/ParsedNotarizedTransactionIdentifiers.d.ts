 ...
 */
export declare function instanceOfParsedNotarizedTransactionIdentifiers(value: object): boolean;
export declare function ParsedNotarizedTransactionIdentifiersFromJSON(json: any): ParsedNotarizedTransactionIdentifiers;
export declare function ParsedNotarizedTransactionIdentifiersFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParsedNotarizedTransactionIdentifiers;
export declare function ParsedNotarizedTransactionIdentifiersToJSON(value?: ParsedNotarizedTransactionIdentifiers | null): any;
