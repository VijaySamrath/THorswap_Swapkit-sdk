 ...
 * @export
 */
export declare const NonFungibleResourceManagerDataEntrySubstateAllOfSubstateTypeEnum: {
 ...
 */
export declare function instanceOfNonFungibleResourceManagerDataEntrySubstateAllOf(value: object): boolean;
export declare function NonFungibleResourceManagerDataEntrySubstateAllOfFromJSON(json: any): NonFungibleResourceManagerDataEntrySubstateAllOf;
export declare function NonFungibleResourceManagerDataEntrySubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): NonFungibleResourceManagerDataEntrySubstateAllOf;
export declare function NonFungibleResourceManagerDataEntrySubstateAllOfToJSON(value?: NonFungibleResourceManagerDataEntrySubstateAllOf | null): any;
