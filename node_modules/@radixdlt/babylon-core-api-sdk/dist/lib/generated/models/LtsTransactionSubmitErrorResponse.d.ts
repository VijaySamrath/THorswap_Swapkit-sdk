 ...
 * @export
 */
export declare const LtsTransactionSubmitErrorResponseErrorTypeEnum: {
 ...
 */
export declare function instanceOfLtsTransactionSubmitErrorResponse(value: object): boolean;
export declare function LtsTransactionSubmitErrorResponseFromJSON(json: any): LtsTransactionSubmitErrorResponse;
export declare function LtsTransactionSubmitErrorResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): LtsTransactionSubmitErrorResponse;
export declare function LtsTransactionSubmitErrorResponseToJSON(value?: LtsTransactionSubmitErrorResponse | null): any;
