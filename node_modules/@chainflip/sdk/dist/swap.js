...
var enumValues, safeStringify, errorMap2, string, number, numericString, numericOrEmptyString, hexString, hexStringWithMaxByteSize, hexStringFromNumber, btcAddress, DOT_PREFIX, dotAddress, ethereumAddress, chainflipAddress, u128, unsignedInteger, rustEnum, chain, asset, uncheckedAssetAndChain, assetAndChain, chainflipSS58Prefix;
var init_parsers = __esm({
  "../shared/src/parsers.ts"() {
    ...
    hexStringFromNumber = numericString.transform((arg) => `0x${BigInt(arg).toString(16)}`);
...
var _SwapSDK = class _SwapSDK {
  ...
  async requestDepositAddress(depositAddressRequest) {
    ...
    if (this.options.broker !== void 0) {
      ...
      const result = await requestSwapDepositAddress2(depositAddressRequest, {
        ...this.options.broker,
