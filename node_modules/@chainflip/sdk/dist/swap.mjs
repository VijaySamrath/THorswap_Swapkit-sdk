import { getEnvironment, getSupportedAssets, getAllBoostPoolsDepth, getVaultContractAddress, approve, getTokenContractAddress, getEvmChainId, checkAllowance, extractOverrides, Vault__factory } from './chunk-IV2YVU2E.mjs';
import { assertValidAddress, ccmMetadataSchema, dotAddress } from './chunk-YTHKYS6R.mjs';
...
var _SwapSDK = class _SwapSDK {
  ...
  async requestDepositAddress(depositAddressRequest) {
    ...
    if (this.options.broker !== void 0) {
      const { requestSwapDepositAddress } = await import('./broker-IJDZMA3Y.mjs');
      const result = await requestSwapDepositAddress(depositAddressRequest, {
        ...this.options.broker,
