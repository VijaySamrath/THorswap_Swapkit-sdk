...
const makeRecursiveFieldStructImplem = (transport, types, filters) => {
    ...
    const recursiveFieldStructImplem = (destructedType_1, data_1, ...args_1) => __awaiter(void 0, [destructedType_1, data_1, ...args_1], void 0, function* (destructedType, data, path = "") {
        ...
        const isCustomType = !utils_2.EIP712_TYPE_PROPERTIES[((_b = typeDescription === null || typeDescription === void 0 ? void 0 : typeDescription.name) === null || _b === void 0 ? void 0 : _b.toUpperCase()) || ""];
        if (Array.isArray(data) && typeof currSize !== "undefined") {
            ...
            for (const [fieldName, fieldValue] of Object.entries(data)) {
                ...
                if (fieldType) {
                    yield recursiveFieldStructImplem((0, utils_2.destructTypeFromString)(fieldType), fieldValue, `${path}.${fieldName}`);
                }
            }
        }
        else {
...
const sendStructImplem = (transport, structImplem) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (structType === "field") {
        ...
        const encodedData = (_a = utils_2.EIP712_TYPE_ENCODERS[type.toUpperCase()]) === null || _a === void 0 ? void 0 : _a.call(utils_2.EIP712_TYPE_ENCODERS, rawData, sizeInBits);
        if (encodedData) {
 ...
 * @returns {Promise}
 */
const signEIP712Message = (transport_1, path_1, jsonMessage_1, ...args_1) => __awaiter(void 0, [transport_1, path_1, jsonMessage_1, ...args_1], void 0, function* (transport, path, jsonMessage, fullImplem = false, loadConfig) {
    let APDU_FIELDS;
    (function (APDU_FIELDS) {
        APDU_FIELDS[APDU_FIELDS["CLA"] = 224] = "CLA";
    ...
    const filters = yield (0, index_1.getFiltersForMessage)(jsonMessage, cryptoassetsBaseURL);
    ...
    for (const { name, type } of domainTypeFields) {
        ...
        yield recursiveFieldStructImplem((0, utils_2.destructTypeFromString)(type), domainFieldValue);
    }
    if (filters) {
    ...
    for (const { name, type } of primaryTypeFields) {
        ...
        yield recursiveFieldStructImplem((0, utils_2.destructTypeFromString)(type), primaryTypeValue, name);
    }
